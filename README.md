...
* https://github.com/guidovezzoni/BingeWorthyShows2 The app shows the most popular TV shows from The Movie Database (Updated in 2023 and currently not maintained)
  * The intersting aspect is a PR comparing RxJava3 vs flow & coroutines - [here](https://github.com/guidovezzoni/BingeWorthyShows2/pull/17/changes)
...
* https://jobbernaut.app/ A lovable app to help candidates searching for their next role, and then, based on their uploaded resume, it allows to:
  * Match CV and job description, highlighting skills compatibility, gaps, etc., so the resume can be impreoved before applying.
...
* PR https://github.com/TeamWanari/appcenter-publish-plugin/pull/9 for https://github.com/TeamWanari/appcenter-publish-plugin, a Gradle Plugin which helps you upload your build artifacts to AppCenter.
